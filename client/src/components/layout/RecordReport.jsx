    ...
    if (loading) {
        return (
            <div className={styles.overlay}>
                <div className={styles.previewContainer} style={{ alignItems: 'center', justifyContent: 'center', padding: '3rem' }}>
        ...
        return (
            <div className={styles.overlay}>
                <div className={styles.previewContainer} style={{ alignItems: 'center', justifyContent: 'center', padding: '3rem' }}>
                    ...
                    <button onClick={onClose} className={styles.btnClose}><X size={16} /> Close</button>
                </div>
            </div>
        );
    }
        ...
        <div className={styles.overlay} onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
            <div className={styles.previewContainer}>
                ...
                <div className={styles.previewBody}>
                    <div className={styles.reportPage} ref={reportRef}>
